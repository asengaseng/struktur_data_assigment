...
```
### Output soal 1 :
![Screenshot Output 1](https://github.com/asengaseng/struktur_data_assigment/blob/main/Modul7/Output-Soal1.png)
...
```
### Output:
![Screenshot Output 2](https://github.com/asengaseng/struktur_data_assigment/blob/main/Modul7/Output-Soal2.png)
...
```
### Output:
![Screenshot Output 3](https://github.com/asengaseng/struktur_data_assigment/blob/main/Modul7/Output-Soal3.png)
