...
```
### Output soal 1 :
![Screenshot Output 1](https://github.com/asengaseng/struktur_data_assigment/blob/main/Modul8/Output-1.png)
...
```
### Output:
![Screenshot Output 2](https://github.com/asengaseng/struktur_data_assigment/blob/main/Modul8/Output-2.png)
...
```
### Output:
![Screenshot Output 3](https://github.com/asengaseng/struktur_data_assigment/blob/main/Modul8/Output-3.png))
